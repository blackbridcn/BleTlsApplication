...
public enum EnumErrorCode {
    ...
    CONN_SERVICE_STATE_ERROR(BleErrorCode.CONN_SERVICE_STATE_ERROR,R.string.ble_service_state_error),
    CONN_WRITE_SERVICE_STATE_ERROR(BleErrorCode.CONN_WRITE_SERVICE_STATE_ERROR,R.string.ble_write_state_error),
    CONN_READ_MSG_ERROR(BleErrorCode.CONN_READ_MSG_ERROR, R.string.ble_read_remote_msg_error),
    CONN_DEVICE_CHARACTERISTIC_ERROR(BleErrorCode.CONN_DEVICE_CHARACTERISTIC_ERROR, R.string.ble_characteristic_error),
