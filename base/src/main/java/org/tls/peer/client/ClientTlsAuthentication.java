...
import org.tls.utils.CertificateUtils;
import org.tls.utils.KeyUtils;
import org.tls.utils.SignersUtils;
...
public class ClientTlsAuthentication implements TlsAuthentication {
    ...
    private TlsClient tlsV2Client;
    protected TlsClientContext context;

    public ClientTlsAuthentication(TlsClient tlsV2Client, TlsClientContext context) {
    ...
    public void notifyServerCertificate(TlsServerCertificate serverCertificate) throws IOException {
        ...
        TlsCertificate rootTlsCertificate = TlsNativeUtils.loadCertificateResource(TlsCryptoSelector.getCrypto(), BaseApplication.getContext(), R.raw.ecc_root_cert);
    ...
    public TlsCredentials getClientCredentials(CertificateRequest certificateRequest) throws IOException {
        ...
        try {
            //加载客户端CA和私钥
            signerCredentials = TlsNativeUtils.loadSignerCredentials(
                    context,
