...
//        addCertSigAlgOID(h, GMObjectIdentifiers.sm2sign_with_sm3, HashAlgorithm.sm3, SignatureAlgorithm.sm2);
    ...
    static byte[] calculateVerifyData(TlsContext context, TlsHandshakeHash handshakeHash, boolean isServer)
        ...
        LogUtils.e("TAG","calculateVerifyData asciiLabel :"+asciiLabel);
        ...
        LogUtils.e("TAG","calculateVerifyData verify_data_length :"+verify_data_length);
...
//            return GMObjectIdentifiers.sm3;
    ...
    static void verifyServerKeyExchangeSignature(TlsContext context,
        ...
        if (streamVerifier != null) {
            ...
            LogUtils.e("TAG","---------> SignatureAndHashAlgorithm :"+sigAndHashAlg);
            //
        ...
        if (!verified) {
            LogUtils.e("TAG", "------------------------------>AlertDescription.decrypt_error");
               throw new TlsFatalAlert(AlertDescription.decrypt_error);
        }
    }
     ...
     *
     * @throws IOException if any certificate in the CertPath (excepting the trust anchor) has a signature
    ...
    static TlsCredentials establishClientCredentials(TlsAuthentication clientAuthentication,
        ...
        TlsCredentials tlsCredentials = clientAuthentication.getClientCredentials(certificateRequest);

        LogUtils.e("TAG", "-------------------->tlsCredentials: " + tlsCredentials.getClass().getSimpleName());
        LogUtils.e("TAG", "-------------------->tlsCredentials: " + (tlsCredentials == null));


        return validateCredentials(tlsCredentials);
    }
