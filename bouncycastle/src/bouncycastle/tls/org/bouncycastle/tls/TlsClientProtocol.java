...
public class TlsClientProtocol
    ...
    public static final String TAG = TlsClientProtocol.class.getSimpleName();
    ...
    protected void handleHandshakeMessage(short type, HandshakeMessageInput buf)
        ...
        switch (type) {
            case HandshakeType.certificate: {
                switch (this.connection_state) {
                    ...
                    case CS_SERVER_SUPPLEMENTAL_DATA: {
                        LogUtils.e(TAG, " CS_SERVER_SUPPLEMENTAL_DATA ");
                        /*
            ...
            case HandshakeType.server_hello: {
                switch (this.connection_state) {
                    case CS_CLIENT_HELLO: {
                        ...
                        // [tls13] Only treat as HRR if it's TLS 1.3??
                        if (serverHello.isHelloRetryRequest()) {
            ...
            case HandshakeType.server_hello_done: {
                LogUtils.e(TAG, "server_hello_done  CS_SERVER_HELLO : " + connection_state);
                switch (this.connection_state) {
                    case CS_SERVER_HELLO: {
                        handleSupplementalData(null);
                        // NB: Fall through to next case label
                    ...
                    case CS_SERVER_CERTIFICATE_REQUEST: {
                        ...
                        if (certificateRequest == null) {
                            ...
                            LogUtils.e(TAG, " certificateRequest  读取Client 证书 ");
                            TlsCredentials clientCredentials = TlsUtils.establishClientCredentials(authentication, certificateRequest);
                            ...
                            LogUtils.e(TAG, " Client端 Build Certificate 数据");
                        ...
                        LogUtils.e(TAG, " handshakeHash :" + handshakeHash.getClass().getSimpleName());

                        TlsUtils.sealHandshakeHash(tlsClientContext, handshakeHash, forceBuffering);

                        LogUtils.e(TAG, " Client端 Build ClientKeyExchange 数据");
                        /*
                        ...
                        if (!isSSL) {
                            LogUtils.e(TAG,"客户端生成 MasterSecret ");
                        ...
                        if (credentialedSigner != null) {
                            ...
                            LogUtils.e(TAG, " Client端 Build CertificateVerify 数据");
                        ...
                        try {
                            ...
                            LogUtils.e(TAG, " Client端 Build FinishedMessage Exception :" + e.getMessage());
                        }
    ...
    protected void handleSupplementalData(Vector serverSupplementalData)
        ...
        LogUtils.e(TAG,"初始化 实例化 TlsKeyExchange TlsECDHEKeyExchange");
...
//        } NewSessionTicket;
    ...
    protected void receiveCertificateRequest(ByteArrayInputStream buf) throws IOException {
        ...
        assertEmpty(buf);
        LogUtils.e(TAG, "-----------------------------------> keyExchange 校验证书请求 ");
        LogUtils.e(TAG, "-----------------------------------> validateCertificateRequest ");
